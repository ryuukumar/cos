 ...
 * @return non-zero if matches, else 0
 */
int isxdigit (char c) { return isdigit (c) || ('a' <= c && c <= 'f') || ('A' <= c && c <= 'F'); }
 ...
 * @return non-zero if matches, else 0
 */
int iscntrl (char c) { return c == (char)127 || ((char)0 <= c && c <= (char)31); }
 ...
 * @return non-zero if matches, else 0
 */
int isgraph (char c) { return (char)33 <= c && c <= (char)126; }
 ...
 * @return non-zero if matches, else 0
 */
int isspace (char c) { return c == ' ' || ((char)9 <= c && c <= (char)13); }
 ...
 * @return non-zero if matches, else 0
 */
int isprint (char c) { return isgraph (c) || c == ' '; }
 ...
 * @return non-zero if matches, else 0
 */
int ispunct (char c) { return isgraph (c) && !isalnum (c); }
